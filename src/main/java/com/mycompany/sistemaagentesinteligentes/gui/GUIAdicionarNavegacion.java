...
public class GUIAdicionarNavegacion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Precision GPS (0-100):");
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        ...
        double precisionGPS;
        try {
            precisionGPS = Double.parseDouble(txtPrecisionGPS.getText().trim());
        } catch (NumberFormatException e) {
        ...
        try {
            AgenteNavegacion ag = new AgenteNavegacion(idAgente, nombre, nivelAutonomia, estadoOperativo, nivelConfianza,
                    origen, destino, precisionGPS);
            servicioAgentes.addAgente(ag);
            JOptionPane.showMessageDialog(this, "¡Agente de navegación creado!");
