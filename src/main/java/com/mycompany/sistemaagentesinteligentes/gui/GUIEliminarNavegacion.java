...
/**
 * Permite eliminar un AgenteNavegacion seleccionandolo de una lista visible,
...
public class GUIEliminarNavegacion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Eliminar Agente de Navegacion");

        JPanel panel = new JPanel(new GridLayout(0, 2, 8, 8));
        panel.setBackground(new Color(21, 101, 192));
        panel.setBorder(javax.swing.BorderFactory.createEmptyBorder(15, 15, 15, 15));

        JLabel lblTitulo = new JLabel("Eliminar Agente de Navegacion");
    ...
    private void actualizarEstadoBoton() {
        btnEliminar.setEnabled(cmbAgentes.getSelectedItem() instanceof AgenteNavegacion);
    }

    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {
        Object seleccionado = cmbAgentes.getSelectedItem();
        if (!(seleccionado instanceof AgenteNavegacion agente)) {
